...
$q = $pdo->prepare("select PRODUK.ID_Produk as id_produk, PRODUK.Nama_Produk as nama_produk, DETAIL_PEMBELIAN.Jumlah_Produk_Beli as jumlah_beli, DETAIL_PEMBELIAN.Harga_Produk_Beli as harga_beli from DETAIL_PEMBELIAN join PRODUK on PRODUK.ID_Produk = DETAIL_PEMBELIAN.ID_Produk where DETAIL_PEMBELIAN.status_del = 1;");
$q->execute();
$history = $q->fetchAll();
?>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $h['jumlah_beli'] ?></td>
                        <td><?= $h['harga_beli'] ?></td>
                        <td><?= ($h['jumlah_beli'] * $h['harga_beli']) ?></td>
                    </tr>
                <?php
                }
                ?>

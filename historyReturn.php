...
$q = $pdo->prepare("select PRODUK.ID_Produk as id_produk, PRODUK.Nama_Produk as nama_produk, RETUR.Jumlah_Produk_Retur as jumlah_retur, RETUR.Harga_Produk_Retur as harga_retur, RETUR.Total_Harga_Retur as total_harga, RETUR.Jenis_Retur as reason from RETUR join PRODUK on PRODUK.ID_Produk = RETUR.ID_Produk where RETUR.status_del = 1;");
$q->execute();
$returns = $q->fetchAll();
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <td class="text-white" style="background-color: #374375;">Reason</td>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    <tr>
                        <td><?= $return['id_produk'] ?></td>
                        <td><?= $return['nama_produk'] ?></td>
                        <td><?= $return['jumlah_retur'] ?></td>
                        <td><?= $return['harga_retur'] ?></td>
                        <td><?= $return['total_harga'] ?></td>
                        <td><?= $return['reason'] ?></td>
                    </tr>
                <?php
                }
